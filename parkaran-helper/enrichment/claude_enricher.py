"""Use Claude API to extract themes, moods, and occasions from shabads."""
...
Return ONLY a JSON array of objects, one per shabad, in order. No markdown formatting."""
    ...
    def disambiguate_match(self, user_title, candidates):
        """
        Use Claude to pick the best BaniDB match for a shabad title.
...
Return ONLY the shabad ID number or "none", nothing else."""
        ...
        # Extract shabad_id from response
        for c in candidates:
